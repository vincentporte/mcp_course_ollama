...
class FileSystemContentLoader(ContentLoader):
    ...
    def _find_module_file(self, module_dir: Path) -> Path | None:
    ...
    def load_module(self, module_id: str) -> CourseModule | None:
        ...
        try:
            ...
            module = self._create_module_from_data(module_id, module_data)
    ...
    def _create_module_from_data(self, module_id: str, data: dict[str, Any]) -> CourseModule:
    ...
    def _load_lesson_from_dir(self, lesson_dir: Path) -> Lesson | None:
    ...
    def _load_lesson_from_file(self, lesson_file: Path) -> Lesson | None:
    ...
    def _create_lesson_from_data(self, lesson_id: str, data: dict[str, Any], content_path: Path | None) -> Lesson:
    ...
    def reload_module(self, module_id: str) -> CourseModule | None:

...
class CourseModule:
    ...
    def add_lesson(self, lesson: Lesson) -> None:
        ...
        self.lessons.sort(key=lambda l: l.order)
    ...
    def get_lesson_by_order(self, order: int) -> Optional[Lesson]:
    ...
    def get_previous_lesson(self, current_lesson_id: str) -> Optional[Lesson]:
